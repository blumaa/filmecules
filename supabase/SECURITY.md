...
Filmclues uses a **single-admin model** where one logged-in user (you) has full administrative privileges, while public users can play published puzzles using the anon key without logging in.
